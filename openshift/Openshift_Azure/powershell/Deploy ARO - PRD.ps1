...
# Create Subnets
az network vnet subnet create -g $ARO_RG --vnet-name $ARO_VNetName -n $ARO_VNet_Subnet_CP --address-prefixes 10.87.117.0/26
az network vnet subnet create -g $ARO_RG --vnet-name $ARO_VNetName -n $ARO_VNet_Subnet_WRK --address-prefixes 10.87.117.64/26
